...
parallel-ssh -t 0 -h vidur/prediction/config/hosts "sudo apt-get install python3-pip -y"
parallel-ssh -t 0 -h vidur/prediction/config/hosts "pip install torch==2.3.0 llumnix torchvision==0.18.0 cupy-cuda12x"
